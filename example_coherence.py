"""Coherence spectrogram with nearest‑timestamp pairing."""
...
def main():
    parser = argparse.ArgumentParser(description="Coherence spectrogram")
    ...
    plt.imshow(
        spec_matrix,  # coherence already in [0,1]
        aspect="auto",
        origin="lower",
    ...
    plt.title(f"Coherence Spectrogram - {cha1_dir.name}/{cha2_dir.name} ({kept} pairs)")
    plt.tight_layout()
